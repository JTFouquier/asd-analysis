...
pdf.title = "_LME_gi_NT_20190729.pdf"

metadata = read.csv("5-NT.csv")
...
getSeverityLabels <- function(metric){
  ...
  if (metric == 'euclidean_gi'){
    y.label = "Gastrointestinal Distress Euclidean Distance Matrix"
    plot.title = "Gastrointestinal Distress Euclidean Distance Matrix"
  }
